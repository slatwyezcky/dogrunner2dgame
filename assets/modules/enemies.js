...
export class Fly extends FlyingEnemy {
  constructor(game) {
    ...
    this.image.src = "/dogrunner2dgame/assets/img/enemy_fly.png";
  }
}
...
export class Bat extends FlyingEnemy {
  constructor(game) {
    ...
    this.maxFrame = 5;
    this.image = new Image();
    this.image.src = "/dogrunner2dgame/assets/img/enemy_bat_3.png";
  }
}
...
export class Ghost extends FlyingEnemy {
  constructor(game) {
    ...
    this.maxFrame = 5;
    this.image = new Image();
    this.image.src = "/dogrunner2dgame/assets/img/enemy_ghost_3.png";
  }
}
...
export class Plant extends GroundEnemy {
  constructor(game) {
    ...
    this.image = new Image();
    this.image.src = "/dogrunner2dgame/assets/img/enemy_plant.png";
    this.speedX = 0;
    this.maxFrame = 1;
  }
}
...
export class GroundZombie extends GroundEnemy {
  constructor(game) {
    ...
    this.y = this.game.height - this.height - this.game.groundMargin;
    this.image = new Image();
    this.image.src = "/dogrunner2dgame/assets/img/enemy_ground_zombie.png";
    this.speedX = 0;
    this.maxFrame = 1;
  }
}
...
export class Zombie extends GroundEnemy {
  constructor(game) {
    ...
    this.y = this.game.height - this.height - this.game.groundMargin;
    this.image = new Image();
    this.image.src = "/dogrunner2dgame/assets/img/enemy_zombie.png";
    this.speedX = Math.random() + 2;
    this.maxFrame = 7;
  }
}
...
export class BigSpider extends ClimbingEnemy {
  constructor(game) {
    ...
    this.image = new Image();
    this.image.src = "/dogrunner2dgame/assets/img/enemy_spider_big.png";
  }
}
...
export class SmallSpider extends ClimbingEnemy {
  constructor(game) {
    ...
    this.y = Math.random() * this.game.height * 0.5;
    this.image = new Image();
    this.image.src = "/dogrunner2dgame/assets/img/enemy_spider.png";
  }
}
